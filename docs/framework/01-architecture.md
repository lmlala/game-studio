...
style:                          # 风格与理念 (一致性批判者的依据)
  tone: "现实规则+架空世界+黑色幽默"
  principles_ref: "football-docs/00-design-card-spec.md#全局原则"  # G1-G10
  glossary_ref: "football-docs/00-design-card-spec.md#术语表"
modules:                        # 系统模块清单 (Phase 1 分解的骨架)
  - {id: narrative-director, doc: "football-docs/03-narrative-director.md"}
  - {id: event-system, doc: "football-docs/05-event-system.md"}
  # ...
...
`football-docs/00a-game-overview.md`，≤2k token，agent 常驻上下文第一项）：
